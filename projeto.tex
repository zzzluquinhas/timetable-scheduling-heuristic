...
\input{sections/2-trabalhosRelacionados.tex}

\input{sections/3-metodologia.tex}

\input{sections/4-cronograma.tex}

\input{sections/5-equipe.tex}

\input{sections/6-consideracoesFinais.tex}
